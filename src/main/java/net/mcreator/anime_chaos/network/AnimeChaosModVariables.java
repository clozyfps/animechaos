package net.mcreator.anime_chaos.network;
...
public class AnimeChaosModVariables {
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			if (!event.isWasDeath()) {
				clone.DojutsuActivated = original.DojutsuActivated;
			}
		}
	}
	...
	public static class PlayerVariables {
		...
		public boolean DojutsuActivated = false;
		public double RightSharinganLevel = 0;
		...
		public Tag writeNBT() {
			...
			nbt.putBoolean("DojutsuActivated", DojutsuActivated);
		...
		public void readNBT(Tag Tag) {
			...
			DojutsuActivated = nbt.getBoolean("DojutsuActivated");
		...
		public static void handler(PlayerVariablesSyncMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
			...
			context.enqueueWork(() -> {
				if (!context.getDirection().getReceptionSide().isServer()) {
					...
					variables.DojutsuActivated = message.data.DojutsuActivated;
