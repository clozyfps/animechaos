...
public class StatScreenScreen extends AbstractContainerScreen<StatScreenMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack,
				...
				ShowNinjaLevelProcedure.execute(entity), 170, 126, -12829636);
		this.font.draw(poseStack,

				ShowNinjaXPRequiredProcedure.execute(entity), 170, 150, -12829636);
		this.font.draw(poseStack,

				ShowSPProcedure.execute(entity), 170, 138, -12829636);
	}
