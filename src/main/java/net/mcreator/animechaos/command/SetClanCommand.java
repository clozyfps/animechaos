...
public class SetClanCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("setclan").requires(s -> s.hasPermission(2)).then(Commands.argument("ClanName", StringArgumentType.word()).executes(arguments -> {
