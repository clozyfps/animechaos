...
public class DemonInfernalDeathRespawnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new DemonInfernalRestingEntity(AnimeChaosModEntities.DEMON_INFERNAL_RESTING.get(), _level);
